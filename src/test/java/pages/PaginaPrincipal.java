...
public class PaginaPrincipal extends BasePage {
    ...
    private String seleccionarRecurso ="/html[1]/body[1]/div[1]/div[1]/div[1]/section[1]/div[1]/header[1]/nav[1]/ul[1]/li[2]/a[1]";
    ...
    public  void  clickRecursos(){
        clickElement(seleccionarRecurso);
    }
}
